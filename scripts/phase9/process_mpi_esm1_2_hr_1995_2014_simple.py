...
base_dir = Path("data/raw/cmip6/mpi_esm1_2_hr/historical")
...
output_file = output_dir / "mpi_esm1_2_hr_historical_1995_2014_processed.nc"

print("Opening MPI-ESM1-2-HR tas file:")
print(tas_file)

print("Opening MPI-ESM1-2-HR pr file:")
print(pr_file)
...
tas.attrs["source_variable"] = "CMIP6 MPI-ESM1-2-HR tas"
...
pr.attrs["source_variable"] = "CMIP6 MPI-ESM1-2-HR pr"
...
ds_out.attrs["title"] = "Processed CMIP6 MPI-ESM1-2-HR monthly data for Korea region"
ds_out.attrs["model"] = "MPI-ESM1-2-HR"
...
print("\nProcessed MPI-ESM1-2-HR file saved:")
print(output_file)
