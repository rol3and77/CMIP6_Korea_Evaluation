...
output_file = output_dir / "mpi_esm1_2_lr_historical_1995_2014_processed.nc"
...
if len(pr_files) == 0:
    raise FileNotFoundError("No pr files found.")
...
ds_out.attrs["title"] = "Processed CMIP6 monthly data for Korea region"
...
print("Processed CMIP6 file saved:")
print(output_file)
